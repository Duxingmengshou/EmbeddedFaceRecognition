...
int VideoDevice::init_device(int w,int h,QString video_fmt)
//int VideoDevice::init_device()
{
    ...
    if (!(QString::compare(video_fmt,"MJPEG")))
    {
        fmt.fmt.pix.pixelformat = V4L2_PIX_FMT_MJPEG;
        qDebug() <<"MJPEG"  <<video_fmt << fmt.fmt.pix.pixelformat;
    }
    else
    {
        fmt.fmt.pix.pixelformat = V4L2_PIX_FMT_YUYV;
        qDebug() <<"YUYV"  <<   video_fmt << fmt.fmt.pix.pixelformat;
    }
    ...
    qDebug() <<"VIDIOC_G_FMT"  <<   video_fmt << fmt.fmt.pix.pixelformat;
